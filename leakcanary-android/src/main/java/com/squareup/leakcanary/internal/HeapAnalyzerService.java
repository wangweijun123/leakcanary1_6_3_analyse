...
public final class HeapAnalyzerService extends ForegroundService
  ...
  @Override protected void onHandleIntentInForeground(@Nullable Intent intent) {
    ...
    CanaryLog.d("HeapAnalyzerService received 命令请求分析 thread name :" + Thread.currentThread().getName());
    ...
    CanaryLog.d("HeapAnalyzerService 分析完毕spend time ms :" + (System.currentTimeMillis()-start));
